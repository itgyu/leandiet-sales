...
export const STORE_MESSAGES = {
  CREATE_SUCCESS: '한의원이 등록되었습니다.',
  CREATE_FAILED: '한의원 등록에 실패했습니다.',
  UPDATE_SUCCESS: '한의원 정보가 수정되었습니다.',
  UPDATE_FAILED: '한의원 수정에 실패했습니다.',
  DELETE_SUCCESS: '한의원이 삭제되었습니다.',
  DELETE_FAILED: '한의원 삭제에 실패했습니다.',
  NOT_FOUND: '한의원을 찾을 수 없습니다.',
  LOAD_FAILED: '한의원 목록을 불러오는데 실패했습니다.',
  DUPLICATE_NAME: '이미 존재하는 한의원명입니다.',
};
