 ...
 * @property {Array} stores - 전체 한의원 목록
 * @property {Array} filteredStores - 필터링된 한의원 목록
 * @property {Object|null} selectedStore - 선택된 한의원 상세 정보
 ...
 * @property {number} total - 전체 한의원 수
 */
    ...
    (set, get) => ({
      ...
      selectStore: async (storeId) => {
        ...
        try {
          ...
          set({
            loading: false,
            error: '한의원 상세 정보 조회 중 오류가 발생했습니다.'
          });
          return false;
        }
      },
      ...
      updateStoreAdditionalInfo: async (storeId, additionalData) => {
        ...
        try {
          ...
          set({
            loading: false,
            error: '한의원 추가 정보 수정 중 오류가 발생했습니다.'
          });
          return false;
        }
      },
