...
export const useAuthStore = create(
  devtools(
    (set, get) => ({
      ...
      user: typeof window !== 'undefined' ? JSON.parse(sessionStorage.getItem('leandiet_user') || 'null') : null,
      token: typeof window !== 'undefined' ? sessionStorage.getItem('leandiet_token') : null,
      isAuthenticated: typeof window !== 'undefined' ? !!sessionStorage.getItem('leandiet_token') : false,
      isLoading: false,
      isRestoring: false,
      isValidating: false,
      error: null,
        ...
        try {
          ...
          if (data.success && data.data) {
            ...
            if (typeof window !== 'undefined') {
              sessionStorage.setItem('leandiet_token', data.data.token);
              sessionStorage.setItem('leandiet_user', JSON.stringify(data.data.user));
            }
            ...
            if (typeof window !== 'undefined') {
              sessionStorage.setItem('leandiet_token', data.token);
              sessionStorage.setItem('leandiet_user', JSON.stringify(data.user));
            }
      ...
      logout: () => {
        // sessionStorage 클리어
        if (typeof window !== 'undefined') {
          sessionStorage.removeItem('leandiet_token');
          sessionStorage.removeItem('leandiet_user');
        }
      ...
      restoreSession: async () => {
        ...
        try {
          ...
          if (typeof window !== 'undefined') {
            token = sessionStorage.getItem('leandiet_token');
            const savedUserStr = sessionStorage.getItem('leandiet_user');
          ...
          if (response.ok) {
            if (data && (data.id || data.user?.id)) {
              ...
              if (JSON.stringify(currentStateUser) !== JSON.stringify(userData)) {
                ...
                if (typeof window !== 'undefined') {
                  sessionStorage.setItem('leandiet_user', JSON.stringify(userData));
                }
              }
            }
