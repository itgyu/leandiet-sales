                  ...
                  <div style={{
                    ...
                    {daySchedules.slice(0, 3).map((schedule, scheduleIndex) => (
                      <div
                        ...
                        title={`${schedule.visit_time?.substring(0, 5)} ${schedule.store_name || '한의원명 없음'} - ${schedule.visit_purpose}`}
                      >
                        {schedule.visit_time?.substring(0, 5)} {schedule.store_name || '한의원명 없음'}
                      </div>
                    ))}
            ...
            <div style={{
              ...
              <div style={{
                ...
                {getSchedulesForDate(selectedDate).map((schedule, index) => {
                  ...
                  const storeName = schedule.store_name || '한의원명 없음';
                    ...
                    >
                      <div style={{
                        ...
                        <span style={{
                          ...
                          color: schedule.visit_type === 'first' ? '#8b5cf6' : '#4e5968',
