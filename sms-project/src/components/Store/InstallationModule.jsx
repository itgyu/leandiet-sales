 ...
 * @param {Object} props
 * @param {Object} props.store - 한의원 정보
 */
const InstallationModule = ({ store }) => {
  ...
  const handleSendUrl = async () => {
    try {
      await sendUrl({
        message: `안녕하세요! ${store.name} 한의원의 린다이어트 온라인 가입 링크를 보내드립니다.`,
        senderName: '린다이어트 영업팀'
      });
    } catch (error) {
            ...
            {!linkStatus.hasActiveLink ? (
              ...
              <div className="text-center py-6">
                ...
                <p className="text-sm text-gray-500 mb-4">
                  한의원에서 직접 가입할 수 있도록 온라인 가입 링크를 발송해주세요.
                </p>
                <Button
        ...
        return (
          <div className="text-center py-6">
            ...
            <p className="text-sm text-gray-500">
              한의원 상태가 '도입확정'이 되면 온라인 가입 링크를 발송할 수 있습니다.
            </p>
          </div>
        );
    }
