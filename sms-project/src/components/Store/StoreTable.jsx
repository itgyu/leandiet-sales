...
/**
 * StoreTable 컴포넌트 - 한의원 테이블
 * @param {Object} props
 * @param {Array} props.stores - 한의원 데이터
    ...
    }] : []),
    {
      ...
      render: (value) => {
        const statusColors = {
          ...
          'REMOTE_INSTALL_SCHEDULED': { bgColor: '#ddd6fe', textColor: '#6d28d9' },
          ...
          'PENDING': { bgColor: '#ddd6fe', textColor: '#6d28d9' }
        };
