              ...
              <div style={{ marginBottom: '20px' }}>
                <div style={{
                  ...
                  <div style={{
                    ...
                    <h4 style={{ fontSize: '14px', fontWeight: '600', color: '#374151', margin: 0 }}>린다이어트 서비스 이용약관</h4>
                    <button
                      type="button"
                      onClick={() => {
                        ...
                        content.innerHTML = `
                          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                            <h2 style="font-size: 18px; font-weight: 600; color: #111827; margin: 0;">린다이어트 서비스 이용약관</h2>
                          ...
                          <div style="font-size: 14px; line-height: 1.8; color: #374151;">
                            ...
                            <p style="margin-bottom: 12px;">본 약관은 린다이어트(이하 "회사")가 제공하는 QR 주문 서비스(이하 "서비스")의 이용과 관련하여 회사와 고객 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.</p>
                            ...
                            <p style="margin-bottom: 12px;">3. 한의원 운영에 필요한 관리 도구를 제공합니다.</p>
