                  ...
                  {item.hasDropdown ? (
                    <>
                      ...
                      <button
                        ...
                        style={{
                          ...
                          border: '1px solid',
                          borderColor: item.children?.some(child => location.pathname === child.path) ? '#8b5cf6' : '#e5e7eb',
                          borderRadius: '8px',
                          fontSize: '15px',
                          fontWeight: '500',
                          color: item.children?.some(child => location.pathname === child.path) ? '#8b5cf6' : '#374151',
                          cursor: 'pointer'
                        }}
                      >
                            ...
                            .map(child => (
                              <button
                                ...
                                style={{
                                  ...
                                  border: '1px solid',
                                  borderColor: location.pathname === child.path ? '#8b5cf6' : '#e5e7eb',
                                  borderRadius: '6px',
                                  fontSize: '14px',
                                  fontWeight: location.pathname === child.path ? '600' : '400',
                                  color: location.pathname === child.path ? '#8b5cf6' : '#6b7280',
                                  cursor: 'pointer'
                                }}
                              >
                                {child.name}
                    ...
                    <button
                      ...
                      style={{
                        ...
                        border: '1px solid',
                        borderColor: location.pathname === item.path ? '#8b5cf6' : '#e5e7eb',
                        borderRadius: '8px',
                        fontSize: '15px',
