...
export const storeApi = {
  async getStores(filters = {}) {
    ...
    if (result.success) {
      ...
      throw new Error(result.error || '한의원 조회 실패');
    }
  },
  ...
  async getStoreDetail(storeId) {
    ...
    if (result.success) {
      ...
      throw new Error(result.error || '한의원 상세 조회 실패');
    }
  },
  ...
  async updateStore(storeId, updateData) {
    ...
    if (result.success) {
      ...
      throw new Error(result.error || '한의원 정보 수정 실패');
    }
  },
  ...
  async createStore(storeData) {
    ...
    if (result.success) {
      ...
      throw new Error(result.error || '한의원 생성 실패');
    }
  },
  ...
  async deleteStore(storeId) {
    ...
    if (result.success) {
      ...
      throw new Error(result.error || '한의원 삭제 실패');
    }
  }
};
