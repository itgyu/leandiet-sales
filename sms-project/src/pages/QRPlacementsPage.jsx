...
const QRPlacementsPage = () => {
  ...
  const handleDownload = () => {
    const headers = ['제출일', '입력한한의원명', '사진수', '매칭상태', '매칭한의원명'];
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px' }}>
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <p style={{ fontSize: '14px', color: '#6b7280', marginBottom: '16px' }}>
              한의원에서 제출한 설치 인증 사진을 확인하고 매칭합니다
            </p>
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    color: statusFilter === tab.key ? '#a78bfa' : '#6b7280',
                    backgroundColor: 'transparent',
                    border: 'none',
                    borderBottom: statusFilter === tab.key ? '2px solid #a78bfa' : '2px solid transparent',
                    cursor: 'pointer',
                    marginBottom: '-1px'
                  }}
                >
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ backgroundColor: '#f9fafb' }}>
                  ...
                  <th style={{ padding: '12px 16px', textAlign: 'left', fontSize: '13px', fontWeight: '600', color: '#374151' }}>입력한 한의원명</th>
              ...
              <div style={{ padding: '24px' }}>
                ...
                <div style={{ marginBottom: '24px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                    <div>
                      <label style={{ fontSize: '12px', color: '#6b7280' }}>입력한 한의원명</label>
