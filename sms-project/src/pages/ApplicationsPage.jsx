...
const ApplicationsPage = () => {
  ...
  const handleDownload = () => {
    const BOM = '\uFEFF';
    const headers = ['신청일', '요청유형', '회원번호', '한의원명', '담당자명', '연락처', '상태'];
          ...
          {['ALL', 'PENDING', 'APPROVED', 'REJECTED'].map(status => (
            <button
              ...
              style={{
                ...
                color: selectedStatus === status ? '#8b5cf6' : '#6b7280',
                border: 'none',
                borderBottom: selectedStatus === status ? '2px solid #8b5cf6' : '2px solid transparent',
                fontSize: '14px',
                fontWeight: '600',
                cursor: 'pointer',
                transition: 'all 0.2s'
