...
const ConsentFormPage = () => {
  ...
  useEffect(() => {
    const loadConsentForm = async () => {
      try {
        ...
        // 한의원 정보 설정
        setStoreInfo({
          store_name: data.store_name || '한의원 정보 없음',
        ...
        console.error('한의원 정보 조회 실패:', err);
        console.error('에러 상세:', err.message);
        
        let errorMessage = '한의원 정보를 불러올 수 없습니다.';
        if (err.message.includes('400')) {
          errorMessage = '유효하지 않은 링크입니다. 링크를 다시 확인해주세요.';
        } else if (err.message.includes('404')) {
          errorMessage = '한의원 정보를 찾을 수 없습니다.';
        ...
        // 에러 발생해도 기본 한의원 정보는 설정
        setStoreInfo({
          store_name: '한의원 정보를 불러올 수 없음',
          store_phone: '',
          owner_name: '담당자명 없음',
          link_id: '',
          token: storeId
  ...
  const validateForm = () => {
    ...
    if (!storeCodeStr.trim()) {
      newErrors.sticker_type = '한의원코드를 입력해주세요.';
    }
        ...
        <div style={{
          ...
          {storeInfo && (
            <div style={{
              ...
              <div>한의원명: {storeInfo.store_name}</div>
        ...
        {apiError && (
          <div style={{
            ...
            <div style={{
              ...
              한의원 정보를 불러올 수 없지만, 아래 폼은 정상적으로 작성하실 수 있습니다.
            </div>
          </div>
        )}
          ...
          <div style={{ marginBottom: '32px' }}>
            <div style={{
              ...
              <div style={{
                ...
                <h4 style={{ fontSize: '16px', fontWeight: '600', color: '#374151', margin: 0 }}>린다이어트 서비스 이용약관</h4>
                <button
                  type="button"
                  onClick={() => {
                    ...
                    content.innerHTML = `
                      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; border-bottom: 2px solid #f3f4f6; padding-bottom: 16px;">
                        <h2 style="font-size: 22px; font-weight: 700; color: #111827; margin: 0;">린다이어트 서비스 이용약관</h2>
                      ...
                      <div style="font-size: 15px; line-height: 1.8; color: #374151;">
                        <h3 style="font-size: 17px; font-weight: 600; margin-top: 20px; margin-bottom: 12px; color: #8b5cf6;">제1조 (목적)</h3>
                        <p style="margin-bottom: 16px; padding-left: 16px;">본 약관은 린다이어트(이하 "회사")가 제공하는 QR 주문 서비스(이하 "서비스")의 이용과 관련하여 회사와 고객 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.</p>
                        
                        <h3 style="font-size: 17px; font-weight: 600; margin-top: 20px; margin-bottom: 12px; color: #8b5cf6;">제2조 (서비스 내용)</h3>
                        <div style="padding-left: 16px; margin-bottom: 16px;">
                          ...
                          <p style="margin-bottom: 10px;">3. 한의원 운영에 필요한 관리 도구를 제공합니다.</p>
                          <p style="margin-bottom: 10px;">4. 주문 데이터 분석 및 통계 기능을 제공합니다.</p>
                        </div>
                        
                        <h3 style="font-size: 17px; font-weight: 600; margin-top: 20px; margin-bottom: 12px; color: #8b5cf6;">제3조 (서비스 설치 및 설정)</h3>
                        <div style="padding-left: 16px; margin-bottom: 16px;">
                          <p style="margin-bottom: 10px;">1. 서비스 설치는 원격으로 진행되며, 고객의 협조가 필요합니다.</p>
                          <p style="margin-bottom: 10px;">2. POS 연동을 위해 POS 아이디, 패스워드, 한의원코드 등의 정보를 정확히 제공해야 합니다.</p>
                        ...
                        <h3 style="font-size: 17px; font-weight: 600; margin-top: 20px; margin-bottom: 12px; color: #8b5cf6;">제4조 (QR 스티커 제작 및 배송)</h3>
                        <div style="padding-left: 16px; margin-bottom: 16px;">
                        ...
                        <h3 style="font-size: 17px; font-weight: 600; margin-top: 20px; margin-bottom: 12px; color: #8b5cf6;">제5조 (개인정보보호)</h3>
                        <div style="padding-left: 16px; margin-bottom: 16px;">
                        ...
                        <h3 style="font-size: 17px; font-weight: 600; margin-top: 20px; margin-bottom: 12px; color: #8b5cf6;">제6조 (서비스 이용료 및 결제)</h3>
                        <div style="padding-left: 16px; margin-bottom: 16px;">
                        ...
                        <h3 style="font-size: 17px; font-weight: 600; margin-top: 20px; margin-bottom: 12px; color: #8b5cf6;">제7조 (고객지원)</h3>
                        <div style="padding-left: 16px; margin-bottom: 16px;">
                          ...
                          <p style="margin-bottom: 10px;">3. 전화: 1588-0000 / 이메일: cs@leandiet.co.kr</p>
                          <p style="margin-bottom: 10px;">4. 긴급 장애 대응은 24시간 핫라인을 통해 지원됩니다.</p>
                        </div>
                        
                        <h3 style="font-size: 17px; font-weight: 600; margin-top: 20px; margin-bottom: 12px; color: #8b5cf6;">제8조 (약관의 변경)</h3>
                        <div style="padding-left: 16px; margin-bottom: 16px;">
