...
const StoreDetailPage = () => {
  ...
  useEffect(() => {
    const fetchStore = async () => {
      try {
        ...
        console.error('한의원 상세 조회 실패:', err);
        setError('한의원 정보를 불러오는데 실패했습니다.');
      } finally {
        setLoading(false);
      }
    };
  ...
  const getStatusDisplay = (status) => {
    const statusConfig = {
      ...
      'REMOTE_INSTALL_SCHEDULED': { label: '에이전트설치예정', bg: '#ddd6fe', text: '#6d28d9' },
      ...
      'PENDING': { label: '보류', bg: '#ddd6fe', text: '#6d28d9' }
    };
    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f8fafc' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ marginTop: '20px', fontSize: '16px', color: '#64748b', fontWeight: '500' }}>한의원 정보를 불러오는 중...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f8fafc' }}>
        <div style={{ 
          ...
          <h3 style={{ fontSize: '20px', fontWeight: '700', color: '#111827', margin: '0 0 12px 0' }}>한의원을 찾을 수 없습니다</h3>
          <p style={{ fontSize: '15px', color: '#6b7280', marginBottom: '32px' }}>요청하신 한의원 정보가 존재하지 않습니다.</p>
          <button
            onClick={() => navigate('/stores')}
            style={{
              padding: '16px 32px',
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
                ...
                {isAdmin() && (
                  <button
                    ...
                    style={{
                      padding: '6px 12px',
                      backgroundColor: isSaving ? '#9ca3af' : (isEditingBasic ? '#10b981' : '#8b5cf6'),
                      color: 'white',
                      border: 'none',
                      borderRadius: '6px',
                      fontSize: '12px',
            ...
            <div style={{ 
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
                ...
                <button
                  ...
                  style={{
                    padding: '6px 12px',
                    backgroundColor: isSaving ? '#9ca3af' : (isEditingAdditional ? '#10b981' : '#8b5cf6'),
                    color: 'white',
                    border: 'none',
                    borderRadius: '6px',
                    fontSize: '12px',
                ...
                <div style={{
                  ...
                  <button
                    ...
                    style={{
                      width: '32px',
                      height: '32px',
                      backgroundColor: newLogContent.trim() ? '#8b5cf6' : '#e5e7eb',
                      border: 'none',
                      borderRadius: '16px',
                        ...
                        {(() => {
                          ...
                          return (
                            <div style={{ fontSize: '13px', color: '#475569', fontFamily: 'SUIT' }}>
                              ...
                              <div style={{ marginBottom: '8px' }}>
                                <strong>한의원 연락처:</strong> {response.table_count || '미정'}
                              </div>
                              <div style={{ marginBottom: '8px' }}>
                                <strong>한의원 번호:</strong> {response.sticker_type || '미정'}
                              </div>
                              <div style={{ marginBottom: '8px' }}>
