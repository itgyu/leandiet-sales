...
const QRMenuManagementPage = () => {
  ...
  const handleDownload = () => {
    const headers = ['신청일', '회원번호', '한의원명', '담당자명', '연락처', '상태'];
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '24px' }}>
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <p style={{ fontSize: '14px', color: '#6b7280', marginBottom: '16px' }}>
              QR메뉴 신청 내역을 관리하고 QR오더 한의원으로 전환합니다
            </p>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ backgroundColor: '#f9fafb' }}>
                  ...
                  <th style={{ padding: '12px 16px', textAlign: 'left', fontSize: '13px', fontWeight: '600', color: '#374151' }}>한의원명</th>
              ...
              <div style={{ padding: '24px' }}>
                ...
                <div style={{ marginBottom: '24px' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                    ...
                    <div>
                      <label style={{ fontSize: '12px', color: '#6b7280' }}>한의원명</label>
