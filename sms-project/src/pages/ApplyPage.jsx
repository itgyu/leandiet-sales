        ...
        >
          <form onSubmit={handleSubmit}>
            ...
            <button
              ...
              onMouseOver={(e) => { if (!submitting) e.target.style.backgroundColor = '#6d28d9' }}
              onMouseOut={(e) => { if (!submitting) e.target.style.backgroundColor = '#8b5cf6' }}
            >
